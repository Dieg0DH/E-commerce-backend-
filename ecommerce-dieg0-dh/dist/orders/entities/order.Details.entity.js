...
let OrderDetails = class OrderDetails {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => String }, price: { required: true, type: () => Number }, product: { required: true, type: () => [require("../../products/entities/product.entity").Products] }, order: { required: true, type: () => require("./order.entity").Orders } };
    }
};
