...
const order_Details_entity_1 = require("../../orders/entities/order.Details.entity");
...
__decorate([
    (0, typeorm_1.ManyToMany)(() => order_Details_entity_1.OrderDetails, (orderDetail) => orderDetail.product),
